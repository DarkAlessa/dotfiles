...
hi Normal            guifg=#F0F0F0 guibg=#262626 gui=NONE ctermfg=252  ctermbg=236  cterm=NONE

hi Terminal          guifg=fg      guibg=bg      gui=NONE ctermfg=252  ctermbg=236  cterm=NONE
hi Directory         guifg=#899296 guibg=bg      gui=NONE ctermfg=150  ctermbg=236  cterm=NONE
...
" Syntax   [:help E669] --------------------------------------------------------------------------------
" Group 1 Comment
hi Comment           guifg=#6C6C6C guibg=bg gui=ITALIC ctermfg=242 ctermbg=NONE cterm=ITALIC
" Group 2 Constant
hi Constant          guifg=#D09BEE guibg=bg gui=NONE ctermfg=179 ctermbg=NONE cterm=NONE
...
hi Boolean           guifg=#7FE3B1 guibg=bg gui=NONE ctermfg=098 ctermbg=NONE cterm=NONE
hi Number            guifg=#7FE3B1 guibg=bg gui=NONE ctermfg=177 ctermbg=NONE cterm=NONE
hi Float             guifg=#7FE3B1 guibg=bg gui=NONE ctermfg=116 ctermbg=NONE cterm=NONE
" Group 3 Indentifier 
hi Identifier        guifg=#FF8F80 guibg=bg gui=NONE ctermfg=173 ctermbg=NONE cterm=NONE
hi Function          guifg=#6ABFDF guibg=bg gui=NONE ctermfg=107 ctermbg=NONE cterm=NONE
" Group 4 Statement
hi Statement         guifg=#D09BEE guibg=bg gui=NONE ctermfg=220 ctermbg=NONE cterm=NONE
hi Conditional       guifg=#D09BEE guibg=bg gui=NONE ctermfg=222 ctermbg=NONE cterm=NONE
hi Repeat            guifg=#D09BEE guibg=bg gui=NONE ctermfg=173 ctermbg=NONE cterm=NONE
hi Label             guifg=#D09BEE guibg=bg gui=NONE ctermfg=118 ctermbg=NONE cterm=NONE
hi Operator          guifg=fg      guibg=bg gui=NONE ctermfg=254 ctermbg=NONE cterm=NONE
hi Keyword           guifg=#D09BEE guibg=bg gui=NONE ctermfg=220 ctermbg=NONE cterm=NONE
hi Exception         guifg=#D09BEE guibg=bg gui=NONE ctermfg=220 ctermbg=NONE cterm=NONE
" Group 5 Pre-Processor
hi PreProc           guifg=#60D0FD guibg=bg gui=NONE ctermfg=183 ctermbg=NONE cterm=NONE
hi Include           guifg=#D09BEE guibg=bg gui=NONE ctermfg=140 ctermbg=NONE cterm=NONE
...
" Group 6 Type
hi Type              guifg=#D09BEE guibg=bg gui=NONE ctermfg=081 ctermbg=NONE cterm=NONE
hi StorageClass      guifg=#D09BEE guibg=bg gui=NONE ctermfg=117 ctermbg=NONE cterm=NONE
hi Structure         guifg=#D09BEE guibg=bg gui=NONE ctermfg=117 ctermbg=NONE cterm=NONE
hi Typedef           guifg=#D09BEE guibg=bg gui=NONE ctermfg=117 ctermbg=NONE cterm=NONE
" Group 7 Special
