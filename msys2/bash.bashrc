...
if [[ -n "$(command -v getent)" ]] && id -G | grep -q "$(getent -w group 'S-1-16-12288' | cut -d: -f2)"
  ...
  else _ps1_symbol='\[\e[38;2;20;20;20;48;2;152;195;121m\] \$ \[\e[0m\]'
fi
[[ $(declare -p PS1 2>/dev/null | cut -c 1-11) = 'declare -x ' ]] || \
  export PS1='\[\e[38;2;20;20;20;48;2;152;195;121m\]          \W $(__git_ps1 "  %s ")\[\e[0m\]'"${_ps1_symbol}"'\[\e[38;2;152;195;121m\]\[\e[0m\] '
unset _ps1_symbol
